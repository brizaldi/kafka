...
class KafkaBytesBuilder {
  ...
  /// Creates builder with empty buffer.
  KafkaBytesBuilder();

  /// Creates builder and initializes buffer with proper request header.
    ...
    for (var item in items) {
      switch (itemType) {
        ...
        case KafkaType.bytes:
          addBytes(List<int>.from(item));
          break;
        case KafkaType.object:
          throw StateError('Objects are not supported yet');
      }
    }
  }
