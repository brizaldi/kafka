  ...
  Future<List<TopicOffset>> _fetch(
    ...
    for (var host in requests.keys) {
      ...
      for (var o in response.offsets) {
        var error = KafkaServerError(o.errorCode);
        ...
        offsets.add(TopicOffset(o.topicName, o.partitionId, o.offsets.first));
      }
    }
